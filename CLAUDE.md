...
test/
  ...
  gui-logic.test.js        # 102 tests — pure logic functions (buildCommand, parseCliOutput, formatMs, formatCost, formatTokens, detectGitError, detectStaleState, preprocessClaudeOutput, etc.)
...
- **Contract tests**: `contracts.test.js` — 38 tests verifying each module's error handling contract matches this document
